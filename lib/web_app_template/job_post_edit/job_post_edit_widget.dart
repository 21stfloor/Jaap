                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    FlutterFlowDropDown<String>(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '0dw6kbuf' /* Please select... */,
                                      ),
                                      searchHintText:
                                          FFLocalizations.of(context).getText(
                                        'h5y6lx4f' /* Search country... */,
                                      ),
                                      icon: Icon(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if ((_model.regionDropDownValue == null ||
                                          _model.regionDropDownValue == '') ||
                                      (_model.jobTypeDropDownValue == null ||
                                          _model.jobTypeDropDownValue == '')) {
                                    await showDialog(
                                      context: context,
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          ...
                                          content: Text(
                                              'Please select a valid Country and Job Type'),
                                          actions: [
                                            TextButton(
                                              onPressed: () => Navigator.pop(
                                                  alertDialogContext),
                                  ...
                                  await widget!.jobToEdit!.reference.update({
                                    ...createJobRecordData(
