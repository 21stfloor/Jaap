...
import 'agency_profile_view_component_model.dart';
export 'agency_profile_view_component_model.dart';

class AgencyProfileViewComponentWidget extends StatefulWidget {
  ...
  State<AgencyProfileViewComponentWidget> createState() =>
      _AgencyProfileViewComponentWidgetState();
}

class _AgencyProfileViewComponentWidgetState
    extends State<AgencyProfileViewComponentWidget> {
  late AgencyProfileViewComponentModel _model;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      stream: UsersRecord.getDocument(widget!.agencyProfile!.parentReference),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ListView(
                    ...
                    children: [
                      if (widget!.agencyProfile?.aboutUs != null &&
                          widget!.agencyProfile?.aboutUs != '')
                        Padding(
                          padding: EdgeInsets.all(16.0),
                          child: RichText(
