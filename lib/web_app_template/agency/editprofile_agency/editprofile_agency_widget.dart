...
import 'editprofile_agency_model.dart';
export 'editprofile_agency_model.dart';

class EditprofileAgencyWidget extends StatefulWidget {
  const EditprofileAgencyWidget({super.key});

  @override
  State<EditprofileAgencyWidget> createState() =>
      _EditprofileAgencyWidgetState();
}

class _EditprofileAgencyWidgetState extends State<EditprofileAgencyWidget> {
  late EditprofileAgencyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditprofileAgencyModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.agencyProfile = await queryAgencyPofileRecordOnce(
    ...
    _model.editDisplayNAmeFocusNode ??= FocusNode();
                                      ...
                                      child: Padding(
                                        ...
                                        child: AuthUserStreamWidget(
                                          builder: (context) => TextFormField(
                                            controller: _model
                                                .editDisplayNAmeTextController,
                                            focusNode:
                                                _model.editDisplayNAmeFocusNode,
                                            obscureText: false,
                                  ...
                                  children: [
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .aboutUsTextFieldTextController,
                                          focusNode:
                                              _model.aboutUsTextFieldFocusNode,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText:
                                                FFLocalizations.of(context)
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.uploadedFileUrl2 != null &&
                                      _model.uploadedFileUrl2 != '') {
                                    await containerAgencyPofileRecord!.reference
                                        .update(createAgencyPofileRecordData(
                                      imageBuisnessCertificate:
                                          _model.uploadedFileUrl2,
                                    ));
                                    if (_model.certificateUploaded != null &&
                                        _model.certificateUploaded != '') {
                                      await FirebaseStorage.instance
                                          .refFromURL(
                                              _model.certificateUploaded!)
                                ...
                                try {
                                  firestoreBatch.update(
                                      ...
                                      createUsersRecordData(
                                        displayName: _model
                                            .editDisplayNAmeTextController.text,
