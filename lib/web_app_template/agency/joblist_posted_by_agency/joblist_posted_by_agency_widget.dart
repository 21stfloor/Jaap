...
import 'joblist_posted_by_agency_model.dart';
export 'joblist_posted_by_agency_model.dart';

class JoblistPostedByAgencyWidget extends StatefulWidget {
  const JoblistPostedByAgencyWidget({super.key});

  @override
  State<JoblistPostedByAgencyWidget> createState() =>
      _JoblistPostedByAgencyWidgetState();
}

class _JoblistPostedByAgencyWidgetState
    extends State<JoblistPostedByAgencyWidget> {
  late JoblistPostedByAgencyModel _model;
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                context.pushNamed('JobPostCreate');
                              },
                              text: FFLocalizations.of(context).getText(
                                'fdsch40z' /* Post A New Job */,
                              ),
                                ...
                                child: StreamBuilder<List<JobRecord>>(
                                  stream: queryJobRecord(
                                    queryBuilder: (jobRecord) =>
                                        jobRecord.where(
                                      'agency',
                                      isEqualTo: containerAgencyPofileRecord
                                          ?.reference,
                                    ),
                                  ),
                                  builder: (context, snapshot) {
