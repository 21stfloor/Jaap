...
import 'review_agency_component_model.dart';
export 'review_agency_component_model.dart';

class ReviewAgencyComponentWidget extends StatefulWidget {
  const ReviewAgencyComponentWidget({
    super.key,
  ...
  @override
  State<ReviewAgencyComponentWidget> createState() =>
      _ReviewAgencyComponentWidgetState();
}

class _ReviewAgencyComponentWidgetState
    extends State<ReviewAgencyComponentWidget> {
  late ReviewAgencyComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReviewAgencyComponentModel());
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  valueOrDefault<String>(
                                    widget!.agencyProfile?.companyProfile,
                                    '-',
                                  ),
                          ...
                          onPressed: () async {
                            ...
                            try {
                              ...
                              await action_blocks.createNotification(
                                ...
                                user: widget!.userToReview?.reference,
                                message:
                                    'An applicant rated your profile!${_model.ratingBarValue?.toString()}stars was given',
                              );
                              Navigator.pop(context);
                            } finally {
