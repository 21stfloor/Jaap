...
import 'payment_dialog_agency_widget.dart' show PaymentDialogAgencyWidget;
...
class PaymentDialogAgencyModel
    extends FlutterFlowModel<PaymentDialogAgencyWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in paymentDialogAgency widget.
