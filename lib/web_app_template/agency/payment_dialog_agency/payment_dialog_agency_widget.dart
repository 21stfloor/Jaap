...
import 'payment_dialog_agency_model.dart';
export 'payment_dialog_agency_model.dart';

class PaymentDialogAgencyWidget extends StatefulWidget {
  const PaymentDialogAgencyWidget({
    super.key,
    required this.jobPost,
  });

  final DocumentReference? jobPost;

  @override
  State<PaymentDialogAgencyWidget> createState() =>
      _PaymentDialogAgencyWidgetState();
}

class _PaymentDialogAgencyWidgetState extends State<PaymentDialogAgencyWidget> {
  late PaymentDialogAgencyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentDialogAgencyModel());
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'v4peaq5f' /* Select payment method */,
                    ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'mi3e3pys' /* Or use an option below */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
