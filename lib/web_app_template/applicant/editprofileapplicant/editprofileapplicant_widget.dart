...
import 'editprofileapplicant_model.dart';
export 'editprofileapplicant_model.dart';

class EditprofileapplicantWidget extends StatefulWidget {
  const EditprofileapplicantWidget({super.key});

  @override
  State<EditprofileapplicantWidget> createState() =>
      _EditprofileapplicantWidgetState();
}

class _EditprofileapplicantWidgetState
    extends State<EditprofileapplicantWidget> {
  late EditprofileapplicantModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditprofileapplicantModel());
    ...
    _model.birthplaceFieldFocusNode ??= FocusNode();
                                          ...
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              keyboardType:
                                                  TextInputType.streetAddress,
                                              validator: _model
                                                  .bioFieldTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
