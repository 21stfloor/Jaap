...
import 'community_page_agency_model.dart';
export 'community_page_agency_model.dart';

class CommunityPageAgencyWidget extends StatefulWidget {
  const CommunityPageAgencyWidget({super.key});

  @override
  State<CommunityPageAgencyWidget> createState() =>
      _CommunityPageAgencyWidgetState();
}

class _CommunityPageAgencyWidgetState extends State<CommunityPageAgencyWidget> {
  late CommunityPageAgencyModel _model;
