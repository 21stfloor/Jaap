...
import 'admin_video_post_create_model.dart';
export 'admin_video_post_create_model.dart';

class AdminVideoPostCreateWidget extends StatefulWidget {
  const AdminVideoPostCreateWidget({super.key});

  @override
  State<AdminVideoPostCreateWidget> createState() =>
      _AdminVideoPostCreateWidgetState();
}

class _AdminVideoPostCreateWidgetState
    extends State<AdminVideoPostCreateWidget> {
  late AdminVideoPostCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminVideoPostCreateModel());
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          '74xsyiiu' /* Description */,
                                        ),
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'xp5a03q9' /* Enter video description... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await VideoPostRecord.collection
                                            .doc()
                                            .set({
