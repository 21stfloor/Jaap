...
import 'admin_agencies_model.dart';
export 'admin_agencies_model.dart';

class AdminAgenciesWidget extends StatefulWidget {
  const AdminAgenciesWidget({super.key});

  @override
  State<AdminAgenciesWidget> createState() => _AdminAgenciesWidgetState();
}

class _AdminAgenciesWidgetState extends State<AdminAgenciesWidget> {
  late AdminAgenciesModel _model;
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'yfiwo8rj' /* List of agencies registered */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                                                  ...
                                                                  await Navigator
                                                                    ...
                                                                    PageTransition(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        allowRotation:
                                                                            false,
                                                                        tag: containerAgencyPofileRecord!
                                                                            .imageBuisnessCertificate,
                                                                        useHeroAnimation:
                                                                            true,
                                                                      ),
