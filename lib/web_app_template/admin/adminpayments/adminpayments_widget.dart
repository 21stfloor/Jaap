...
import 'adminpayments_model.dart';
export 'adminpayments_model.dart';
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'rc3fhrqs' /* Payment History of Agency */,
                              ),
                                                    ...
                                                    child: StreamBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Visibility(
                                                            visible: listViewPaymentsRecord
                                                                    .hasAccepted() &&
                                                                listViewPaymentsRecord
                                                                    .accepted,
                                                            child: Padding(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Expanded(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                          (context) {
                                                                        if (listViewPaymentsRecord.hasAccepted() &&
                                                                            listViewPaymentsRecord.accepted) {
                                                                          return Text(
                                                                            FFLocalizations.of(context).getText(
                                                                              'fxeprhe7' /* Accepted */,
                                                                            ),
                                                                      ...
                                                                      children: [
                                                                        if ((listViewPaymentsRecord.hasAccepted() ==
                                                                          ...
                                                                          FFButtonWidget(
                                                                            onPressed:
                                                                                () async {
                                                                              await listViewPaymentsRecord.reference.update(createPaymentsRecordData(
                                                                                accepted: true,
                                                                              ));
                                                                            },
                                                                            text:
