...
import 'admin_applicants_model.dart';
export 'admin_applicants_model.dart';

class AdminApplicantsWidget extends StatefulWidget {
  const AdminApplicantsWidget({super.key});

  @override
  State<AdminApplicantsWidget> createState() => _AdminApplicantsWidgetState();
}

class _AdminApplicantsWidgetState extends State<AdminApplicantsWidget> {
  late AdminApplicantsModel _model;
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '4ysshwu8' /* List of applicants registered */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
