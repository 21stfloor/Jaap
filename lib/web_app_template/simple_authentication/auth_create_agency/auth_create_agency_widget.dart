...
import 'auth_create_agency_model.dart';
export 'auth_create_agency_model.dart';

class AuthCreateAgencyWidget extends StatefulWidget {
  const AuthCreateAgencyWidget({
    super.key,
    String? role,
  ...
  @override
  State<AuthCreateAgencyWidget> createState() => _AuthCreateAgencyWidgetState();
}

class _AuthCreateAgencyWidgetState extends State<AuthCreateAgencyWidget> {
  late AuthCreateAgencyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthCreateAgencyModel());
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'i38ntcfc' /* Create Agency Account */,
                                  ),
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'q62819bs' /* After you create your account,... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'hrld6krn' /* Upload Buisness Registratrion ... */,
                                    ),
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            FFLocalizations.of(context).getText(
                                          'yl5zt1f2' /* Already have an account? 
 */
                                          ,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'xtgk1d00' /* Make an Account as Applicant? ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
