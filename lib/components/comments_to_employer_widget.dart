...
import 'comments_to_employer_model.dart';
export 'comments_to_employer_model.dart';

class CommentsToEmployerWidget extends StatefulWidget {
  const CommentsToEmployerWidget({
    super.key,
    required this.employerUser,
    bool? showNames,
  }) : this.showNames = showNames ?? false;

  final DocumentReference? employerUser;
  final bool showNames;

  @override
  State<CommentsToEmployerWidget> createState() =>
      _CommentsToEmployerWidgetState();
}

class _CommentsToEmployerWidgetState extends State<CommentsToEmployerWidget> {
  late CommentsToEmployerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentsToEmployerModel());
