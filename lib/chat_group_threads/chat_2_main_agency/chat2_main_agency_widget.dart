...
import 'chat2_main_agency_model.dart';
export 'chat2_main_agency_model.dart';

class Chat2MainAgencyWidget extends StatefulWidget {
  const Chat2MainAgencyWidget({super.key});

  @override
  State<Chat2MainAgencyWidget> createState() => _Chat2MainAgencyWidgetState();
}

class _Chat2MainAgencyWidgetState extends State<Chat2MainAgencyWidget> {
  late Chat2MainAgencyModel _model;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'fbo5tcpp' /* Below are your chat applicatio... */,
                          ),
                          style:
